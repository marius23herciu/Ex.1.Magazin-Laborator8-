...
namespace Ex._1.Magazin_Laborator8_
{
    class Telefon
    {
        ...
        */
        ...
        private ProducatorTelefon producator;
        private ModelTelefon model;
        ...
        public Telefon(ProducatorTelefon producator, ModelTelefon model)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ProducatorTelefon GetProducator()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ModelTelefon GetModel()
        {
            return this.model;
        }
    }
    enum ProducatorTelefon
    {
        Samsung, iPhone, OnePlus, Nokia, empty
    }
    enum ModelTelefon
    {
        S10, x10, N10, n3310, empty
    }
